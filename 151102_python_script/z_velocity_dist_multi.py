...
def see(i):
   ...
   ds = yt.load(fn)
   ad = ds.all_data()
   cr1 =  ad.cut_region("obj['z']>0.")
   cr2 =  ad.cut_region("obj['z']<0.")
#   cr = ad.cut_region("obj['z-velocity']<0.") and ad_cutregion("obj['z']>-0.")

   profiles.append(create_profile(ad,"z-velocity",["cell_mass"],weight_field=None, logs=None, fractional=True,n_bins=30))
   ...
   plot_specs.append(dict(linestyle="-", alpha=1.0,color='green',linewidth=2.0))
...
#   plot.grid()
   plot.save('z_velocity_dist_'+str(i)+'.png')
